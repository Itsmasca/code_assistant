...
from src.api.modules.files.files_models import FileUpload
...
class KnowledgeBaseController:
    ...
    async def add_to_knowledge_base(self, db: Session, data = File(...), bytes: bytes):
        ...
        file = self.files_service.create(db=db, file=data)
