...
class Llmservice:
    def __init__(self):
        self.llm = ChatAnthropic(temperature=0.1, model="claude-3-sonnet-20240229", api_key= os.getenv("ANTROPHIC_API_KEY"), default_headers={"anthropic-beta": "tools-2024-04-04"}, max_tokens= 32000)  # or the maximum allowed
