...
class Llmservice:
    ...
    def get_solution(self):
        """Returns the generated code solution."""
        return self.solution
    def get_context(self):
        """Returns the concatenated context from Qdrant."""
        concatenated_content = retrieve()
        return concatenated_content
    def get_code_gen_chain(self):
        """Returns the code generation chain with structured output."""
        return self.code_chain_claude_raw
    def set_question(self, question: str):
        """Sets the question for the code generation."""
        self.question = question
    def set_solution(self, agentName: str, improvedPrompt: Optional[str] = None, agentJson: Optional[Any] = None, query: Optional[str] = None):
        """Sets the solution with the provided parameters."""
        if improvedPrompt:
            self.set_question(improvedPrompt)
            print(f"Setting question to: {improvedPrompt}")
    
        concatenated_content = self.get_context() 
        self.solution = self.code_chain_claude_raw.invoke(
            {
                "context": concatenated_content,
                "agentName": agentName,
                ...
                "agentJson": agentJson,
                "messages": [("user", query or self.question)]
            }
        )
    ...
    def run_chain(self):
        ...
        fallback_chain = self.insert_errors | self.code_chain_claude_raw
        N = 3  # Max re-tries
        ...
        return code_gen_chain_no_retry.invoke()